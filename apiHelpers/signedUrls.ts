import { Bucket, getSignedDownloadUrl, getSignedUploadUrl, objectExists } from "./s3Helpers";
...
export const createSignedDownloadUrl = async (a: {
    ...
    const h = a.hash
    const objectKey = joinKeys(a.zone.directory || '', `${a.hashAlg}/${h[0]}${h[1]}/${h[2]}${h[3]}/${h[4]}${h[5]}/${a.hash}`)
